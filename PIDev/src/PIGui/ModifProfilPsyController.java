 ...
 * @author HP
 */
public class ModifProfilPsyController implements Initializable {
    ...
    private void update(ActionEvent event) throws IOException 
    {
        ...
        else 
        {
            ...
            sp.Modifier(new psycho (tfUsernameU.getText(), tfPasswordU.getText(), tfMailU.getText(), java.sql.Date.valueOf((tfDateU.getValue())) ) );

            JOptionPane.showMessageDialog(null,"Psychologist modified");

            FXMLLoader loader2= new FXMLLoader(getClass().getResource("ProfilPsy.fxml"));
