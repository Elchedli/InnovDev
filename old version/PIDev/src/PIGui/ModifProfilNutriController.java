 ...
 * @author HP
 */
public class ModifProfilNutriController implements Initializable {
    ...
    private void update(ActionEvent event) throws IOException 
    {
        ...
        else 
        {
            ...
            sn.Modifier(new nutri (tfUsernameU.getText(), tfPasswordU.getText(), tfMailU.getText(), java.sql.Date.valueOf((tfDateU.getValue())) ) );

            JOptionPane.showMessageDialog(null,"Nutritionist modified");

            FXMLLoader loader2= new FXMLLoader(getClass().getResource("ProfilNutri.fxml"));
